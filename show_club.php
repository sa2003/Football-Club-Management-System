    ...
    <section id="section1">
        ...
        <div style="margin: 10% 10% 50px; text-align: center; background: #66b3ff;">
            ...
            <div class="row" style="padding: 50px;">
                ...
                <!-- Inside the loop that displays club information in show_club.php -->
                <a href="update_club.php?clubID=<?php echo $row[0]; ?>">Update</a>
            </div>
            <?php  
                }
            }
